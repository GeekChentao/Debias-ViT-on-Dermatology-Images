...
# from torchvision.models import vit_h_32, ViT_H_32_Weights
import timm
import pandas as pd
...
grad_norm_clip = 1
checkpoint_path = (
    f"torchvision_vit32h_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
)
output_filename = f"torchvision_vit32h_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
