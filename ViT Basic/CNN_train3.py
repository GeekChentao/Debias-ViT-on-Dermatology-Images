...
grad_norm_clip = 1
checkpoint_path = (
    f"torchvision_cnn_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
)
output_file = f"torchvision_cnn_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
best_model_path = (
    f"torchvision_cnn_skin_{optimizer_type}_{lr}_{scheduler_type}_best_full.pt"
)
