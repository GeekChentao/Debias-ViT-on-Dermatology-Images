...
grad_norm_clip = 1
checkpoint_path = f"MONET_MostPresent_desc_vit32b3_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
output_file = (
    f"MONET_MostPresent_desc_vit32b3_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
)
