...
grad_norm_clip = 1
checkpoint_path = f"MONET_MostPresent_desc_vit32b5_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
output_filename = (
    f"MONET_MostPresent_desc_vit32b5_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
)
