...
grad_norm_clip = 1
checkpoint_path = (
    f"MONET_fulldesc_vit32b4_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
)
output_file = f"MONET_fulldesc_vit32b4_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
