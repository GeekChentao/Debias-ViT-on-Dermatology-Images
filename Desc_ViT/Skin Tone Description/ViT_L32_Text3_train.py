...
grad_norm_clip = 1
checkpoint_path = f"text_vit32l3_skin_{optimizer_type}_{lr}_{scheduler_type}_best.pth"
output_filename = f"text_vit32l3_skin_{optimizer_type}_{lr}_{scheduler_type}.txt"
